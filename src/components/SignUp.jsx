        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-white">Link Aura</h1>
            </div>
            ...
            {!showOtpInput ? (
              <>
                <div className="space-y-4 mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full p-4 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent backdrop-blur-sm pr-12"
                    />
                    <button
                      type="button"
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-4 rounded-xl font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 transform hover:scale-105 shadow-lg"
                  >
                    Sign Up
                  </button>
                </div>
                ...
                <div className="flex justify-center space-x-4 mb-6">
                  <button className="p-3 bg-white/10 border border-white/20 rounded-xl hover:bg-white/20 transition-all duration-300 backdrop-blur-sm">
                    <FcGoogle size={24} />
                  </button>
                  <button className="p-3 bg-white/10 border border-white/20 rounded-xl hover:bg-white/20 transition-all duration-300 backdrop-blur-sm">
